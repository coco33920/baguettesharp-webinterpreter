export var Terminal = (function() {
    ...
    var resetPrompt = function(terminal, prompt) {
        ...
        let height = terminal.offsetHeight;
        let margin = getComputedStyle(terminal);
        let marginTop = parseInt(margin.marginTop);
        let marginBottom = parseInt(margin.marginBottom);
        let total_height = window.innerHeight;
        let childHeight = newPrompt.offsetHeight;
        if(height+marginTop+marginBottom+childHeight+150 >= total_height){
            terminal.innerHTML = "";
            terminal.appendChild(newPrompt);
            newPrompt.querySelector(".input").innerHTML = "&nbsp";
    ...
    self.init = function(elem, commands,elem2) {
        ...
        elem2.onclick = function () {
          ...
          let inp = children[(children.length -1)]
